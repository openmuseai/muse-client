...
final class MusePlatformV1 {
  ...
  factory MusePlatformV1.fromJson(Object? value) {
    ...
    return MusePlatformV1(
        os: stringField(map, 'os'), arch: stringField(map, 'arch'));
  }
...
final class MuseEngineAdapterManifestV1 {
  ...
  factory MuseEngineAdapterManifestV1.fromJson(Map<String, Object?> map) {
    ...
    final capabilities =
        enumList(map, 'capabilities', MuseAdapterCapability.values);
    ...
    final platforms = objectList(map['platforms'], 'platforms')
        .map(MusePlatformV1.fromJson)
        .toList();
    final formats = objectList(map['formats'], 'formats')
        .map(MuseFormatSupportV1.fromJson)
        .toList();
    final materializations =
        enumList(map, 'materializations', MuseMaterializationKind.values);
...
final class MuseProbeRequestV1 {
  ...
  factory MuseProbeRequestV1.fromJson(Map<String, Object?> map) {
    ...
    return MuseProbeRequestV1(
        ...
        requestedMode:
            enumField(map, 'requestedMode', MuseRequestedMode.values),
...
final class MuseProbeQualityV1 {
  const MuseProbeQualityV1(
      {required this.fidelity, required this.startupClass});
  ...
  factory MuseProbeQualityV1.fromJson(Object? value) {
    ...
    final fidelity = switch (raw) {
      ...
      _ =>
        throw MuseContractFormatException('fidelity has unsupported value $raw')
    };
...
final class MuseProbeResultV1 {
  ...
  factory MuseProbeResultV1.fromJson(Map<String, Object?> map) {
    ...
    final kinds =
        enumList(map, 'materializationKinds', MuseMaterializationKind.values);
...
final class MuseOpenMaterializationV1 {
  const MuseOpenMaterializationV1(
      {required this.kind, required this.handleRef, required this.expiresAt});
  ...
  Map<String, Object?> toJson() =>
      {'kind': enumWire(kind), 'handleRef': handleRef, 'expiresAt': expiresAt};
}

final class MuseOpenSurfaceV1 {
  const MuseOpenSurfaceV1(
      {required this.windowRef, required this.placement, required this.reuse});
  ...
  Map<String, Object?> toJson() =>
      {'windowRef': windowRef, 'placement': placement, 'reuse': reuse};
}
...
final class MuseOpenEngineSessionRequestV1 {
  ...
  factory MuseOpenEngineSessionRequestV1.fromJson(Map<String, Object?> map) {
    ...
    return MuseOpenEngineSessionRequestV1(
        ...
        materialization:
            MuseOpenMaterializationV1.fromJson(map['materialization']),
...
sealed class MuseEngineSessionWireValueV1 {
  ...
  factory MuseEngineSessionWireValueV1.fromJson(
          String kind, Map<String, Object?> map) =>
      switch (kind) {
        'manifest' =>
          MuseManifestMessage(MuseEngineAdapterManifestV1.fromJson(map)),
        'probe-request' =>
          MuseProbeRequestMessage(MuseProbeRequestV1.fromJson(map)),
        'probe-result' =>
          MuseProbeResultMessage(MuseProbeResultV1.fromJson(map)),
        'open-session-request' => MuseOpenSessionRequestMessage(
            MuseOpenEngineSessionRequestV1.fromJson(map)),
        'session-handle' =>
          MuseSessionHandleMessage(MuseEngineSessionHandleV1.fromJson(map)),
        'session-event' => MuseSessionEventMessage.parse(map),
        _ =>
          throw MuseContractFormatException('unknown engine schema kind $kind')
      };
}
