...
final class MuseResourceFormat {
  ...
  Map<String, Object?> toJson() =>
      {'formatId': formatId, 'confidence': enumWire(confidence)};
}

final class MuseResourceSecurity {
  const MuseResourceSecurity(
      {required this.classification, required this.activeContent});
  ...
  factory MuseResourceSecurity.fromJson(Object? value) {
    ...
    return MuseResourceSecurity(
      classification:
          enumField(map, 'classification', MuseSecurityClassification.values),
...
final class MuseResourceDescriptorV1 {
  ...
  factory MuseResourceDescriptorV1.fromJson(Map<String, Object?> map) {
    ...
    return MuseResourceDescriptorV1(
      ...
      capabilities:
          enumList(map, 'capabilities', MuseResourceCapability.values),
...
sealed class MuseResourceWireValueV1 {
  ...
  factory MuseResourceWireValueV1.fromJson(
      ...
      switch (kind) {
        'descriptor' =>
          MuseResourceDescriptorMessage(MuseResourceDescriptorV1.fromJson(map)),
        ...
        'commit-request' => MuseResourceOpaqueMessage.parse(
            kind, 'muse.resource/commit-request/v1', map),
        'commit-receipt' => MuseResourceOpaqueMessage.parse(
            kind, 'muse.resource/commit-receipt/v1', map),
        'event' =>
          MuseResourceOpaqueMessage.parse(kind, 'muse.resource/event/v1', map),
...
final class MuseResourceOpaqueMessage extends MuseResourceWireValueV1 {
  ...
  static MuseResourceOpaqueMessage parse(
      String kind, String protocol, Map<String, Object?> map) {
    ...
    for (final field
        in required.difference({'protocol', 'content', 'occurredAt'})) {
    ...
    if (kind == 'commit-receipt') {
      ...
      } else if (!{'denied', 'unsupported', 'cancelled', 'failed'}
          .contains(result)) {
