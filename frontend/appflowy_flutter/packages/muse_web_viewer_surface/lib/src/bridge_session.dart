...
final class MuseViewerBridgeSession {
  ...
  MuseViewerBridgeEvent? receive(
      {required String sourceOrigin, required Map<String, Object?> message}) {
    ...
    if (message['protocol'] != 'muse.viewer-bridge/v1' ||
        message['nonce'] != nonce ||
        message['generation'] != generation) return null;
    ...
    if (page != null && page is! int ||
        errorCode != null && errorCode is! String) return null;
