...
void main() {
  test('conforming adapter passes lifecycle and authority TCK', () async {
    ...
    final report = await const MuseAdapterTck().run(MuseAdapterTckScenario(
        adapter: adapter,
        probeRequest: _probe(),
...
MuseProbeRequestV1 _probe() => const MuseProbeRequestV1(
    ...
    descriptor: MuseProbeDescriptorV1(
        ...
        format: MuseResourceFormat(
            formatId: 'text.plain', confidence: MuseFormatConfidence.verified),
...
final class _Adapter implements MuseEngineAdapter {
  ...
  MuseEngineAdapterManifestV1 get manifest => const MuseEngineAdapterManifestV1(
      ...
      engine: MuseEngineIdentityV1(
          vendor: 'fake', engineId: 'fake', engineVersion: '1'),
      ...
      risk: MuseAdapterRiskV1(
          ...
          requiresGpu: false));
  @override
  Future<MuseProbeResultV1> probe(MuseProbeRequestV1 request,
      ...
      MuseProbeResultV1(
          ...
          effectiveModes: [
            MuseEngineMode.view,
            if (escalate) MuseEngineMode.edit
          ],
